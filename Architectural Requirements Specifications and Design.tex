...
A user should also be able to send a notification. The notification page should have a similar layout as the other pages shown across Figure 1 - 6.
      ...
      \subsection{User Management Subsystem}\label{subsec:users}
			...
			\subsection{Notification Subsystem}\label{subsec:notification}
				...
				\begin{figure}[h!]
					\includegraphics[scale=0.5]{Class_Diagram_Notifications.JPG}
					\caption{Notifications Subsystem Class Diagram}	
				\end{figure}
			
				\begin{figure}[h!]
					\includegraphics[scale=0.5]{Activity_Diagram_Notifications.JPG}
					\caption{Natifications Subsystem Activity Diagram}	
				\end{figure}
				
				\begin{figure}[h!]
					\includegraphics[scale=0.5]{Sequence_Diagram_Notifications.JPG}
					\caption{Notifications Subsystem Sequence Diagram}	
				\end{figure}
				
				\begin{figure}[h!]
					\includegraphics[scale=0.5]{State_Diagram_Notifications.JPG}
					\caption{Notifications Subsystem State Diagram}	
				\end{figure}
				
				\begin{figure}[h!]
					\includegraphics[scale=0.5]{Use_Case_Diagram_Notifications.JPG}
